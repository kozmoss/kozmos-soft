          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 relative min-h-[300vh]">
              {statsData.map((card, index) => (
                <div
                  key={index}
                  className="flex flex-row rounded-none h-24 overflow-scroll md:h-64 sticky transition-all duration-[1000ms]"
                  style={{
                    top: `${4 + index * 3}rem`,
                    zIndex: 10 + index,
                  }}
                >
                  <div
                    className={`${
                      index !== 0 ? "border-t-2" : ""
                    } h-full w-1/3 text-md md:text-xl italic pl-4`}
                  >
                    {card.text
                  ...
                  <div
                    className={`${
                      index !== 0 ? "border-t-2" : ""
                    } border-l-2 w-full flex justify-between h-full bg-card`}
                  >
