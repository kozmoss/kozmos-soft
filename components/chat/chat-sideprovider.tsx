...
const SIDEBAR_KEYBOARD_SHORTCUT = "n" // Changed to a different key to avoid conflict
...
function Sidebar2Trigger({
  ...
  return (
    <Button
      data-sidebar="trigger2"
      data-slot="sidebar2-trigger"
      variant="ghost"
      size="icon"
...
function Sidebar2MenuButton({
...
} & VariantProps<typeof sidebar2MenuButtonVariants>) {
  const Comp = asChild ? Slot : "button"
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebar2MenuButtonVariants({ variant, size }), className)}
      {...props}
    />
  )
    ...
    >
      {showIcon && (
        <Skeleton
          ...
          data-sidebar="menu2-skeleton-icon"
        />
      )}
      <Skeleton
...
export {
  ...
  Sidebar2MenuButton,
  Sidebar2MenuItem,
  Sidebar2MenuSkeleton,
  Sidebar2MenuSub,
  Sidebar2MenuSubButton,
  Sidebar2MenuSubItem,
  Sidebar2Provider,
  Sidebar2Rail,
  Sidebar2Separator,
