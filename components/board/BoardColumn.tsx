...
import { TaskCard, Task } from "./Card";
...
export const BoardColumn = ({ column, tasks, isOverlay }: BoardColumnProps) => {
  ...
  const variants = cva(
    "h-full max-w-[300px] md:w-[300px] sm:w-[200px]  flex flex-col flex-shrink-0 snap-center mt-4 overflow-y-auto",
    {
      variants: {
        dragging: {
  ...
  return (
    <Card
      ...
      <CardHeader className="p-2 border-b-2 flex flex-row items-center justify-between">
        <h1>{column.title}</h1>
